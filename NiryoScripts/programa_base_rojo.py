...
# Conectar al robot
robot = NiryoRobot("192.168.217.107")  # Cambia esta IP por la del robot Niryo Ned2
...
pick_pose = JointsPosition(-1.052,-0.572,-0.022,-0.156,-1.212,-1.020)
pick_pose_arriba = JointsPosition(-1.083,-0.257,0.010,-0.020,-1.246,-1.129)

place_pose = JointsPosition(-0.880,-0.823,0.310,-0.020,-1.071,-2.490)
...
place_pose_cinta = JointsPosition(-1.538,-0.279,-0.143,-0.2706,-1.259,-1.502)
        ...
        try:
            ...
            if color:
                ...
                if color == 'rojo':
                    ...
                    # Intentar detectar y agarrar la pieza
                    obj_found, shape, detected_color = robot.vision_pick("pruebas_bien")
                    ...
                    if obj_found:
                        ...
                        # Colocar la pieza
                        robot.place_from_pose(place_pose_cinta)
